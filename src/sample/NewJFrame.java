...
public class NewJFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        https:
//videoconf-colibri.zoom.us/j/89482472133
        panel3 = new JPanel();
                            ...
                            panel4Layout.createParallelGroup()
                                    .addGroup(panel4Layout.createSequentialGroup()
                                            ...
                                            .addGroup(panel4Layout.createParallelGroup()
                                                    ...
                                                    .addGroup(panel4Layout.createSequentialGroup()
                                                            .addComponent(degreeGradeLabel)
                                                            .addGap(24, 24, 24)
                                                            .addComponent(degreeGradeTextField, GroupLayout.PREFERRED_SIZE, 375, GroupLayout.PREFERRED_SIZE)
                    ...
                    panel4Layout.setVerticalGroup(
                            panel4Layout.createParallelGroup()
                                    .addGroup(panel4Layout.createSequentialGroup()
                                            ...
                                            .addGroup(panel4Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                                    .addComponent(degreeGradeLabel)
                                                    .addComponent(degreeGradeTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                                            .addGap(34, 34, 34)
